    ...
    public class Xnor : DrawableFactory
    {
        ...
        private class Instance(string name) : ScaledOrientedDrawable(name), IStandardizedDrawable, IBoxDrawable
        {
            ...
            protected override void Draw(IGraphicsBuilder builder)
            {
                ...
                {
                    case 0: DrawXnorIEC(builder, style); break;
                    case 1:
                    default: DrawXnor(builder, style); break;
                }
            }
            private void DrawXnor(IGraphicsBuilder builder, IStyle style)
            {
            ...
            private void DrawXnorIEC(IGraphicsBuilder builder, IStyle style)
            {
                builder.ExtendPins(Pins, style);
