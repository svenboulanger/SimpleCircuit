        ...
        private class Instance(string name) : ScaledOrientedDrawable(name), IStandardizedDrawable, IBoxDrawable
        {
            ...
            protected override void Draw(IGraphicsBuilder builder)
            {
                ...
                switch (Variants.Select(Options.European, Options.American))
                {
                    ...
                    case 1:
                    default: DrawNor(builder, style); break;
                }
            }
            private void DrawNor(IGraphicsBuilder builder, IStyle style)
            {
            ...
            private void DrawNorIEC(IGraphicsBuilder builder, IStyle style)
            {
                builder.ExtendPins(Pins, style);
