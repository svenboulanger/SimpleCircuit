...
public class Battery : DrawableFactory
{
    ...
    private class Instance : ScaledOrientedDrawable
    {
        ...
        public Instance(string name)
            : base(name)
        {
            AddPin(new FixedOrientedPin("negative", "The negative pin", this, new(-1, 0), new(-1, 0)), "n", "neg", "b");
            AddPin(new FixedOrientedPin("positive", "The positive pin", this, new(1, 0), new(1, 0)), "p", "pos", "a");
        }
