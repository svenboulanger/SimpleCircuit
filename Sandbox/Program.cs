...
namespace Sandbox
{
    public class Program
    {
        static void Main()
        {
            ...
            string script = @".symbol TEST
    <pins>
        <pin name=""origin"" x=""0"" y=""0"" nx=""-1"" ny=""0"" />
    </pins>
    <drawing>
        <circle x=""0"" y=""0"" r=""0.1"" thickness=""1"" bg=""--foreground"" />
        <line x1=""0"" y1=""0"" x2=""10"" y2=""0"" />
        <text x=""10"" y=""0"" nx=""1"" ny=""0"" anchor=""left"" mode=""upright"" value=""Test"" />
    </drawing>
.ends
