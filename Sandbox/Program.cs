...
namespace Sandbox
{
    public class Program
    {
        static void Main()
        {
            ...
            string script = @".symbol LBLS
    <pins>
        <pin name=""in"" x=""0"" y=""0"" nx=""-1"" ny=""0"" />
        <pin name=""out"" x=""0"" y=""0"" nx=""1"" ny=""0"" />
    </pins>
    <drawing>
        <text x=""0"" y=""-1"" anchor=""center-baseline"" value=""value"" />
        <label x=""0"" y=""1"" anchor=""top"" />
    </drawing>
.ends
X <r> LBLS(""label 1"") <?> X
X <a 20> LBLS(""label 2"") <?> X
X <a 45> LBLS(""label 3"") <?> X
";
