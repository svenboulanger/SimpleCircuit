    ...
    public class Demo
    {
        ...
        public static Demo[] Demos { get; } = new[]
        {
            ...
            new Demo("Demo: 3T Pixel array", "An array of CMOS 3T pixels. Also a demonstration of subcircuits.", string.Join(Environment.NewLine, new[] {
                ...
                "PIXEL1 <r> PIXEL2",
                "PIXEL1[bottom] <d> [top]PIXEL3",
                "PIXEL3 <r> PIXEL4[DIRtop_o] <u> [bottom]PIXEL2",
                "",
                "// Add some terminals",
                "PIXEL1[top] <u 0> T(\"COL OUT k\")",
                "PIXEL2[top] <u 0> T(\"COL OUT k+1\")",
                "PIXEL2[right] <r 0> T(\"ROW SEL i\")",
                "PIXEL4[right] <r 0> T(\"ROW SEL i+1\")",
            })),
            ...
            new Demo("Demo: Transformers", "A demo of some improvised transformers.", string.Join(Environment.NewLine, new[]
            {
                ...
                "",
                "// Primary side",
                "V1 <u r d> [pa]M1[pb] <d l u> V1",
                "",
                "// Secondary side to second transformer",
                "M1[sa] <u r d> [pa]M2[pb] <d l u> [sb]M1",
                "",
                "// Load",
                "M2[sa] <u r d> RL <d l u> [sb]M2",
                "",
                "// Alignment",
