...
{
    /// <summary>
    /// A multiplication of contributors.
    /// </summary>
    /// <seealso cref="Contributor" />
    public class MultipliedContributor : Contributor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultipliedContributor"/> class.
        /// </summary>
        /// <param name="a">The first contributor.</param>
        /// <param name="b">The second contributor.</param>
        /// <param name="type">The unknown type.</param>
        public MultipliedContributor(Contributor a, Contributor b, UnknownTypes type)
        {
        ...
        {
            return new MultipliedContribution(
