...
namespace SimpleCircuit.Contributors
{
    ...
    public class OffsetXContributor : Contributor
    {
        private readonly Contributor _x, _sx, _sy, _a;
        private readonly Vector2 _relative;

        /// <inheritdoc/>
        public override UnknownTypes Type => UnknownTypes.X;

        /// <inheritdoc/>
        public override double Value => _x.Value + _sx.Value * _relative.X * Math.Cos(_a.Value) - _sy.Value * _relative.Y * Math.Sin(_a.Value);
        ...
        public OffsetXContributor(Contributor x, Contributor sx, Contributor sy, Contributor a, Vector2 relative)
        {
